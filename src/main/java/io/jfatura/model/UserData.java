...
public record UserData(
    ...
    public static final class Builder {
        ...
        public Builder registryNo(String v) { this.registryNo = v; return this; }
        public Builder mersisNo(String v) { this.mersisNo = v; return this; }
        ...
        public Builder businessCenter(String v) { this.businessCenter = v; return this; }

        public UserData build() {
            return new UserData(taxIDOrTRID, title, name, surname, registryNo, mersisNo,
                    taxOffice, fullAddress, buildingName, buildingNumber, doorNumber, town,
                    district, city, zipCode, country, phoneNumber, faxNumber, email, webSite,
                    businessCenter);
        }
    }
}
